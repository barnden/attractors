...
let qaz = (init, get_x, get_y, next, color) => {
    ...
    function setup() {
        ...
        // For some reason, compiling with emscripten breaks after the ~19 next() call
        // Testing upto 2 million next() calls using gcc-10 with C++20 works fine.
        loop()
    }
